            ...
            $("#daishenhe").dataTable({
                ...
                columnDefs: [{
                    ...
                    render: function (data, type, row, meta) {
                        return '<a href="javascript:void(0);" style="float:left" class="btn btn-success sure">通过</a><br/><a href="javascript:void(0);" style="float:left;margin-left:5px;margin-top:-15%;" class="btn btn-danger unsure">不通过</a>'
                    }
                }]
